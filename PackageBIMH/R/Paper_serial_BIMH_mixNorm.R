# Paper_serial_BIMH_mixNorm
Paper_serial_BIMH_mixNorm = function(x_start, p, b)
{

  ans = .C("Paper_serial_BIMH_mixNorm", as.double(x_start), as.integer(p),
...
# Paper_serial_parallel_BIMH_mixNorm
diagn_Paper_serial_BIMH_mixNorm = function(x_start, p, b)
{
  time = system.time(out <- Paper_serial_BIMH_mixNorm(x_start, p, b))
