# parallel_BIMH_mixNorm
FullParallel_BIMH_mixNorm = function(x_start, p, b)
{

  ans = .C("FullParallel_BIMH_mixNorm", as.double(x_start), as.integer(p),
...
# diagn_parallel_BIMH_mixNorm
diagn_FullParallel_BIMH_mixNorm = function(x_start, p, b)
{
  time = system.time(out <- FullParallel_BIMH_mixNorm(x_start, p, b))
